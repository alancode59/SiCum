...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Empleado Nuevo</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Formulario para un nuevo empleado</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form-usuario" action="../backend/crud/Empleados/insert_empleado.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                                        <img src="../img/icono-empleado.png" class="img-rounded" alt="" id="img-preview" width="20%">
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rol">
                                            ...
                                            <option value="555">Administrador</option>
                                            <option value="444">Operador</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="file" name="foto_perfil" id="foto_perfil" onchange="" class="form-control" id="foto-input">
                                </div>
                            </div>
    ...
    <script src="../js/empleado_nuevo.js"></script>
  </body>
