<?php
  ...
  if(!isset($_SESSION['id_empleado'])){
    ...
    $query_text = 'SELECT empleados.id_empleado, empleados.estatus_empleado, empleados.nombre_empleado, empleados.ap_paterno_empleado, empleados.ap_materno_empleado, empleados.imagen_empleado, roles.rol FROM empleados INNER JOIN roles ON empleados.id_rol = roles.id_rol WHERE empleados.id_empleado !="'.$_SESSION["id_empleado"].'";';
    // echo $query_text;
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <!-- Sidebar Menu -->
          <nav class="mt-2">
            <?php echo crear_menu_panel('empleados');?>
          </nav>
          <!-- /.sidebar-menu -->
        </div>
        <!-- /.sidebar -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a href="./empleado_nuevo.php" class="btn btn-secondary btn-sm">Agregar nuevo</a><br><br>
                        <div class="card">
                                          ...
                                          if(isset($empleados) && sizeof($empleados) > 0){
                                            ...
                                            foreach ($empleados as $empleado) {
                                              $html.= '
                                                <tr>
                                                    <td>'.++$num.'</td>
                                                    <td>'.$empleado["nombre_empleado"].' '.$empleado["ap_paterno_empleado"].' '.$empleado["ap_materno_empleado"].'</td>
                                                    <td><center><img src="../img/'.$empleado["imagen_empleado"].'" id="img-preview" width="10%" height="5%"></center></td>
                                                    <td>'.$empleado["rol"].'</td>
                                                    <td>';
                                                      if ($empleado["estatus_empleado"] != 1) {
                                                        $html.='<a href="../backend/crud/Empleados/update_estatus.php?id_empleado='.$empleado["id_empleado"].'&estatus=2" class="btn btn-info btn-sm">Habilitar</a>';
                                                      }//end if
                                                      else{
                                                        $html.='<a href="../backend/crud/Empleados/update_estatus.php?id_empleado='.$empleado["id_empleado"].'&estatus=1" class="btn btn-primary btn-sm">Deshabilitar</a>';
                                                      }//end else
                                                        
                                                        $html.='<a href="../backend/crud/Empleados/delete_empleado.php?id_empleado='.$empleado["id_empleado"].'" class="btn btn-danger btn-sm">Eliminar</a>
                                                        <a href="./empleado_detalles.php?id_empleado='.$empleado["id_empleado"].'" class="btn btn-warning btn-sm">Detalles</a>
                                                    </td>
                                                </tr>
                                              ';
                                            }//end foreach
