<?php
    ...
    if(empty($id_usuario)){
        ...
        if(sizeof($usuario) <= 0){
          echo '<script>
                alert("Error, el producto que deseas actualizar no esxiste");
                window.location = "./usuarios.php";
                </script>';
        }//
        ...
        <!-- /.content-header -->
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form-usuario" action="../backend/crud/usuarios/update_usuario.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                                        <img src="<?php echo ($usuario['imagen_usuario'] == NULL) ? '../img/icono-usuario.png' : '../img/'.$usuario['imagen_usuario']; ?>" class="img-rounded" alt="" id="img-preview" width="10%">
                                    </center>
                                </div>
                            </div>
                            <input type="hidden" value="<?php echo $usuario['imagen_usuario']; ?>" name="foto_perfil_actual">
                            <input type="hidden" value="<?php echo $usuario['id_usuario']; ?>" name="id_usuario">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nombre(s)</label>
                                        <input type="text" value="<?php echo $usuario['nombre_usuario']; ?>" name="nombre" class="form-control" id="nombre" placeholder="Nombre(s)">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Apellido Paterno</label>
                                        <input type="text" value="<?php echo $usuario['ap_paterno_usuario']; ?>" name="apellido_paterno" class="form-control" id="apellido_paterno" placeholder="Apelldio Paterno">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Apellido Materno</label>
                                        <input type="text" value="<?php echo $usuario['ap_materno_usuario']; ?>" name="apellido_materno" class="form-control" id="apellido_materno" placeholder="Apelldio Paterno">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sexo" value="1" <?php echo ($usuario['sexo_usuario'] == 1) ? 'checked' : '';?>>
                                            <label class="form-check-label">Femenino</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sexo" value="2" <?php echo ($usuario['sexo_usuario'] == 2) ? 'checked' : '';?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" value="<?php echo $usuario["email_usuario"]; ?>" class="form-control" id="email" placeholder="Correo electrónico">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="montoM" value="<?php echo $usuario["monto_pago_mensual"]; ?>" class="form-control" id="pagoM" placeholder="Pago mensual del usuario">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fechai" value="<?php echo $usuario["fecha_inicio"]; ?>" class="form-control" id="fechai" placeholder="Fecha de inicio del usuario">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fechap" value="<?php echo $usuario["fecha_de_pago"]; ?>" class="form-control" id="fechap" placeholder="Fecha de pago mensual del usuario">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="file" name="foto_perfil" id="foto_perfil" class="form-control" id="foto-input">
                                </div>
                            </div>
