...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Formulario para actualizar empleado</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form-usuario" action="../backend/crud/Empleados/update_empleado.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $empleado['ap_materno_empleado']; ?>" name="apellido_materno" class="form-control" id="apellido_materno" placeholder="Apelldio Materno">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sexo" value="2" <?php echo ($empleado['sexo_empleado'] == 2) ? 'checked' : '';?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rol">
                                            ...
                                            <option value="444" <?php echo ($empleado['id_rol'] == 444) ? 'selected' : '';?> >Operador</option>
                                        </select>
                                    </div>
                                </div>
    ...
    <script src="../js/empleado_detalles.js"></script>
  </body>
